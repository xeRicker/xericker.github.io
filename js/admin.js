...
function buildWeekSummaries() {
    ...
    const topRevenue = weeks.reduce((leader, week) => (!leader || week.total > leader.total ? week : leader), null);
    if (topRevenue && topRevenue.total > 0 && weeks.length > 1) topRevenue.isTopRevenue = true;
