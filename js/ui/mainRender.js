            ...
            <div class="employee-row animate-stagger" style="animation-delay:${i*0.05}s">
                <div class="employee-info">
                    ...
                    <div class="preset-btn-wrapper">
                        <button class="btn-preset"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="10"></circle><polyline points="12 6 12 12 16 14"></polyline></svg></button>
